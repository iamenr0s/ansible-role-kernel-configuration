...
Instead, report them privately via [GitHub private vulnerability reporting](https://github.com/iamenr0s/ansible-role-kernel-configuration/security/advisories/new).
